    ...
    return (
        <section className="py-20 px-4 md:px-12 w-full">
            <div className="mb-12 flex justify-between items-end">
                ...
                <p className="hidden md:block w-full md:w-[600px] text-2xl text-muted-foreground/80 leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 auto-rows-[350px]">
                {SPACES.map((space, i) => (
                    ...
                    >
                        ...
                        <div className="absolute bottom-0 left-0 p-8 w-full">
                            <span className="inline-block px-6 py-1 rounded-full border border-white/20 bg-black/40 backdrop-blur-md text-md font-medium text-white -ms-2 mb-4">
                                Starting at {space.price}
                            </span>
                            <h3 className="font-display text-3xl md:text-4xl font-medium text-white mb-2 group-hover:text-primary transition-colors">
                                {space.title}
                            </h3>
                            <p className="text-base text-gray-300 line-clamp-1">{space.desc}</p>
                        </div>
                    </motion.div>
                ))}

                {/* CTA Block - 1 Column */}
                <div className="md:col-span-1 bg-primary text-black rounded-[2.5rem] p-10 flex flex-col justify-between group overflow-hidden relative">
                    <div className="relative z-10">
                        <h3 className="font-display text-4xl font-medium leading-[1.1] mb-4">Can't find it?</h3>
                        <p className="text-black/70 mb-8 text-2xl">We build custom solutions for enterprise teams.</p>
                    </div>
                ...
                {/* Map Block - 3 Columns */}
                <div className="md:col-span-3 bg-[#112628] rounded-[2.5rem] relative overflow-hidden border border-white/5 p-8 flex flex-col justify-between">
                    ...
                    <div className="relative z-10 w-full flex justify-between items-start pointer-events-none">
                        <h3 className="font-display text-4xl text-white font-medium">Space Network</h3>
